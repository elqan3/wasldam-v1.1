...
export function DropletIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 2C12 2 5 10.5 5 15a7 7 0 1 0 14 0C19 10.5 12 2 12 2zm0 19a4 4 0 0 1-4-4c0-2.5 2.5-6.5 4-8.5 1.5 2 4 6 4 8.5a4 4 0 0 1-4 4z" />
    </svg>
  );
}
...
export function HeartHandshakeIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
